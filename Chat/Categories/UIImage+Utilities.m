...
#pragma mark- 返回jpegimage 小于500KB
+(UIImage *)jpegImage :(UIImage *)scrImage{
    UIImage *image = scrImage;
    
    // Determine output size
    CGFloat maxSize = 768.0f;
