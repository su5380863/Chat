...
//            [ChatTools showLabelView:@"您麦克风已被禁用，请在\"设置-隐私-麦克风\"中允许访问你的麦克风" rootView:AppLicationWindow superController:AppRootViewController];
        }
...
- (void)stopRecord
{
    ...
    if (cTime > 2) {
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(failRecord)]) {
