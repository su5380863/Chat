...
#define IconSize_Match_ExtraSize      3.f
#define MatchMaxHeight  1000000.f

#define BEGIN_TAG @"["
#define END_TAG @"]"

#define MatchImage_Regular  @"\\[[^\\[\\]\\s]{1,6}\\]" //匹配图片的正则
...
@property(nonatomic) BOOL nameLink;
@property(nonatomic) BOOL spaceiLink;
